...
namespace TradeSatoshi.Web.ModelBinder
{
	...
	public class DataTablesModelBinder : IModelBinder
	{
		...
		{
			DataTablesModel obj = new DataTablesModel();
		...
		private DataTablesModel BindLegacyModel(IValueProvider valueProvider, int columns)
		{
			DataTablesModel obj = new DataTablesModel(columns);
